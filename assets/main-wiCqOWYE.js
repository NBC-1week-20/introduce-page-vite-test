...
축구 보는 거랑 음악 듣기 등등 있습니다.`},{name:"장희수",id:"4",image:"./asset/images/jhs_profile_image.jpeg",description:"899"}],u={apiKey:"AIzaSyBtVPaMcwLkX8OC8fVfAjpZDxfacykBREU",authDomain:"sparta-e02dc.firebaseapp.com",projectId:"sparta-e02dc",storageBucket:"sparta-e02dc.firebasestorage.app",messagingSenderId:"1000457952288",appId:"1:1000457952288:web:472fe9e7f48a94cea37045",measurementId:"G-H41TVN2QFP"},E=l(u),B=d(E);async function I(){let e=document.getElementById("comment-list");e.innerHTML="",(await r(p(g(B,"details"),y("timestamp","desc"),f(3)))).forEach(m=>{let n=m.data(),s=n.author_name,a=n.content,i=n.timestamp?n.timestamp.toDate().toLocaleString():"날짜 없음",c=`<p class="comment"><strong>${s}:</strong> ${a} <br> <small>${i}</small></p>`;e.innerHTML+=c})}window.onload=I;function h(e){return`
